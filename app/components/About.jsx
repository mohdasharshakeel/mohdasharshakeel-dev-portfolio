      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            MongoDB. Built multiple live projects, developing scalable,
            high-performance web apps with responsive, modern UIs. Skilled in
            RESTful APIs, AI integration, and performance optimization.
          </p>
          ...
          <ul className="flex items-center gap-3 sm:gap-5">
            {toolsData.map((tool, index) => (
              <li
                ...
                key={index}
              >
                <Image src={tool} alt="icon" className="w-5 sm:w-7" />
              </li>
            ))}
          </ul>
        </div>
