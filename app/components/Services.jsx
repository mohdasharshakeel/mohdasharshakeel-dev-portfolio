  ...
  return (
    ...
    >
      ...
      <p className="text-center max-w-xl sm:max-w-2xl mx-auto mt-5 mb-12 text-sm sm:text-base font-Ovo">
        Transforming ideas into powerful digital products — I design and develop
        full-stack solutions with precision, performance, and creativity. From
        concept to deployment, I deliver modern, scalable, and impactful
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-10 mt-1">
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          >
            ...
            <a
              href={link}
              className="flex items-center justify-center gap-2 text-sm sm:text-base mt-3 text-blue-600 font-Ovo"
            >
              Read more{" "}
              <Image src={assets.right_arrow} alt="" className="w-4 sm:w-5" />
            </a>
          </div>
        ))}
      </div>
